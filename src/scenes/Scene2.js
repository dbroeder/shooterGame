...
export class Scene2 extends Phaser.Scene {
  ...
  create() {
    ...
    this.ship1 = this.add.sprite(this.cameras.main.width / 2 - 50, this.cameras.main.height / 2, "ship");
    this.ship2 = this.add.sprite(this.cameras.main.width / 2, this.cameras.main.height / 2, "ship2");
    this.ship3 = this.add.sprite(this.cameras.main.width / 2 + 50, this.cameras.main.height / 2, "ship3");
  ...
  update() {
    ...
    if (Phaser.Input.Keyboard.JustDown(this.spacebar)) {
      if (this.player.active) {
        for (let i = 0; i < gameSettings.beamNum; i++) {
          if (i % 2 == 0) {
            this.shootBeam(i * -5);
          } else {
            this.shootBeam(i * 10)
